...
//                                     <button
//                                         onClick={() => {
//                                             const selectedDetails = selectedCategory.map(
//                                               (item, i) =>
//                                                 i !== 0
//                                                   ? `${field[i - 1].field_name.toString()} - ${
//                                                       item.detail_id.toString() + "\n"
//                                                     }`.replaceAll(",", "-")
//                                                   : null
//                                             );
...
//                                               }\n${selectedDetails.filter((item) => item !== null).join('')}
//                                               Name:${name}\nPrice: ${price}\nQuantity: ${quantity}`
//                                             );
//                                           }}
//                                         style={{
...
function AddStocks() {
  ...
  const handleGenerate = async () => {
    ...
    const requestData = {
      ...
      // Assuming you are using some function to send the data to the backend, for example, using fetch:
